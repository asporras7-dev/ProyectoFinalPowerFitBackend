...
router.post('/', CategoriaPublicacionController.create);
router.put('/:id', CategoriaPublicacionController.update);
router.delete('/:id', CategoriaPublicacionController.delete);
